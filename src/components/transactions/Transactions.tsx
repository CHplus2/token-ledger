...
export const Transactions: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#111114] rounded-xl border border-[#222226] p-4 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-3 text-xs">
        ...
        {selectedTxIds.length > 0 && (
          <div className="flex items-center gap-2 bg-purple-500/15 px-3 py-1.5 rounded-lg border border-purple-500/30">
            <span className="font-bold text-purple-200">{selectedTxIds.length} Selected</span>
            <button
              ...
              <tr className="border-b border-[#222226] text-slate-400 font-semibold bg-[#16161c]">
                <th className="py-3 px-3 w-8">
                  <input
                    ...
                    className="rounded bg-[#16161c] border-[#2d2d35] text-purple-600 focus:ring-purple-500 cursor-pointer"
                  />
                </th>
            ...
            <tbody className="divide-y divide-[#1e1e24]">
              {filteredTransactions.map((tx) => {
                ...
                return (
                  <tr
                    key={tx.id}
                    className={`hover:bg-[#16161c]/80 transition-colors ${
                  ...
                  >
                    ...
                    <td
                      className="py-3 px-3 font-medium text-white cursor-pointer hover:text-purple-400"
                      onClick={() => setSelectedTx(tx)}
                    >
                      <div className="flex items-center gap-1.5">
                        <span className="font-semibold text-white">{tx.businessDescription}</span>
                        {isSolana && (
                      ...
                      <span className="block text-[11px] text-slate-500 font-mono truncate max-w-[240px]" title={tx.txHash}>
                    ...
                    <td className="py-3 px-3 text-slate-400">
                      ...
                      <span className="text-[10px] text-slate-500 font-mono block ml-4">{tx.sourceName}</span>
                    </td>
                    ...
                    <td className="py-3 px-3 text-right">
                      <button
                        onClick={() => setSelectedTx(tx)}
                        className="px-2.5 py-1 rounded-lg bg-[#16161c] hover:bg-[#1c1c21] text-slate-200 border border-[#222226] font-semibold text-[11px] transition-colors cursor-pointer"
                      >
                        Details
                      </button>
                    </td>
          ...
          <div className="bg-[#111114] rounded-xl shadow-2xl border border-[#222226] w-full max-w-md p-6 animate-in zoom-in-95 text-white">
            ...
            <div className="space-y-2">
              {[
                ...
                <button
                  ...
                  className="w-full text-left p-3 rounded-lg border border-[#222226] bg-[#16161c] hover:border-purple-500/50 hover:bg-[#1c1c21] text-xs font-semibold text-slate-200 transition-colors cursor-pointer"
                >
                  {item.label}
                </button>
              ))}
            ...
            <div className="mt-4 pt-3 border-t border-[#222226] flex justify-end">
              <button
                ...
                className="px-3 py-1.5 rounded-lg border border-[#2d2d35] hover:bg-[#1c1c21] text-xs font-medium text-slate-300 cursor-pointer"
              >
                Cancel
              </button>
            </div>
